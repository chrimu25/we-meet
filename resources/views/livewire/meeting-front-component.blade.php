<div class="row">
  ...
  $currentEvent = ($meeting->meeting_date->format('Y-m-d') == $currentDate) AND ((now() >= $meeting->start_time) && ($meeting->end_time > now()));
      ...
      <div class="card shadow">
        <div class="row">
          <div class="col-lg-12 align-self-center">
            @if($meeting->meeting_date->format('Y-m-d') == date('Y-m-d'))
          ...
          <div class="w-100 d-flex justify-content-between align-items-center">
            ...
            @auth
              ...
              @if(auth()->user()->role == 'Youth' && auth()->user()->youthDetails->attendedMeetings()->find($meeting->id))
